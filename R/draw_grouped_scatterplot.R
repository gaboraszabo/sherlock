...
draw_grouped_scatterplot <- function(data, y_var, grouping_var_1, grouping_var_2, grouping_var_3, group_color = FALSE, alpha = 0.5, interactive = FALSE) {
  ...
  paneled_theme_element <-
    ggplot2::theme(
      ...
      strip.background  = ggplot2::ggplot2::element_rect(fill = "white", color = "grey70", size = 0.5),
      strip.text        = ggplot2::ggplot2::element_text(size = 11, color = "grey50"),
      plot.title        = ggplot2::ggplot2::element_text(size = 16, color = "grey50"),
      plot.subtitle     = ggplot2::ggplot2::element_text(size = 12, color = "grey70"),
      axis.title.x      = ggplot2::ggplot2::element_text(size = 12, color = "grey70"),
      axis.title.y      = ggplot2::ggplot2::element_text(size = 12, color = "grey70"),
      axis.text.x       = ggplot2::ggplot2::element_text(size = 11, color = "grey70"),
      axis.text.y       = ggplot2::ggplot2::element_text(size = 12, color = "grey70"),
      axis.line.x.bottom        = ggplot2::ggplot2::element_line(color = "grey70", size = 0.5),
      axis.line.y.left  = ggplot2::ggplot2::element_line(color = "grey70", size = 0.5),
      axis.line.y.right = ggplot2::ggplot2::element_line(color = "grey70", size = 0.5),
      axis.text.y.right = ggplot2::ggplot2::element_blank(),
      legend.position   = "none",
      plot.caption      = ggplot2::ggplot2::element_text(color = "grey50"),
